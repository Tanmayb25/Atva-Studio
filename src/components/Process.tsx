            ...
            {STEPS.map((step, index) => {
              ...
              return (
                <li key={step.id} className="relative">
                  ...
                  >
                    {/* Step number — sits above centered content */}
                    <span
                      className={[
                        "block font-mono text-3xl font-bold tabular-nums tracking-tighter transition-colors duration-300 md:text-4xl mb-4",
                        isActive ? "text-[#FF5733]" : isPast ? "text-[#FF5733]/55" : "text-white/15",
                      ].join(" ")}
                    >
                      {step.number}
                    ...
                    <div className="text-center space-y-3">
                      ...
                      <p
                        className={[
                          "mx-auto max-w-2xl text-pretty text-sm leading-relaxed transition-colors duration-300 md:text-base md:leading-relaxed",
                          isActive ? "text-white/72" : "text-white/45 group-hover:text-white/58",
                        ].join(" ")}
                      >
                        {step.description}
